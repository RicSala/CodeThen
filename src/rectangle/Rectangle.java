...
public class Rectangle {
	public static void main(String[] args) {
		assertEquals(drawRectable("*", 3, 5), "*****%n*****%n*****%n");
		assertEquals(drawRectable("*", 4, 4), "****%n****%n****%n****%n");
		assertEquals(drawRectable("*", 0, 0), "");
		assertEquals(drawRectable("*", 0, 1), "");
		assertEquals(drawRectable("*", 1, 0), "");
		assertEquals(drawRectable("*", 1, 100), "****************************************************************************************************%n");
	}


		/**
		 * FUNCTION: draw a rectangle with a String
		 * @param s String used
		 * @param rows # of rows
		 * @param columns # of columns
		 * @return a String containing the rectangle (print with printf)
		 */
		private static String drawRectable (String s,int rows, int columns){
			String rectangle = "";
			if (rows != 0 && columns != 0) {
		...
		/**
		 * FUNCTION: returns a rectangle with a string.
		 * @param s String used
		 * @param rows # of rows
		 * @param columns # of columns
		 * @return a String containing the rectangle (print with printf)
